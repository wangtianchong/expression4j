 ...
 */
public class OperatorDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements fr.expression4j.config.OperatorDocument
{
     ...
     */
    public fr.expression4j.config.OperatorDocument.Operator getOperator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            fr.expression4j.config.OperatorDocument.Operator target = null;
            target = (fr.expression4j.config.OperatorDocument.Operator)get_store().find_element_user(OPERATOR$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOperator(fr.expression4j.config.OperatorDocument.Operator operator)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class OperatorImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements fr.expression4j.config.OperatorDocument.Operator
    {
