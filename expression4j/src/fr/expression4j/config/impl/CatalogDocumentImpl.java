 ...
 */
public class CatalogDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements fr.expression4j.config.CatalogDocument
{
     ...
     */
    public fr.expression4j.config.CatalogDocument.Catalog getCatalog()
    {
        synchronized (monitor())
        {
            check_orphaned();
            fr.expression4j.config.CatalogDocument.Catalog target = null;
            target = (fr.expression4j.config.CatalogDocument.Catalog)get_store().find_element_user(CATALOG$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setCatalog(fr.expression4j.config.CatalogDocument.Catalog catalog)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class CatalogImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements fr.expression4j.config.CatalogDocument.Catalog
    {
         ...
         */
        public fr.expression4j.config.Expression[] getExpressionArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                fr.expression4j.config.Expression[] result = new fr.expression4j.config.Expression[targetList.size()];
         ...
         */
        public fr.expression4j.config.Expression getExpressionArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Expression target = null;
                target = (fr.expression4j.config.Expression)get_store().find_element_user(EXPRESSION$0, i);
                if (target == null)
                {
         ...
         */
        public void setExpressionArray(fr.expression4j.config.Expression[] expressionArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setExpressionArray(int i, fr.expression4j.config.Expression expression)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public fr.expression4j.config.Expression insertNewExpression(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Expression target = null;
                target = (fr.expression4j.config.Expression)get_store().insert_element_user(EXPRESSION$0, i);
                return target;
            }
        }
         ...
         */
        public fr.expression4j.config.Expression addNewExpression()
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Expression target = null;
                target = (fr.expression4j.config.Expression)get_store().add_element_user(EXPRESSION$0);
                return target;
            }
        }
         ...
         */
        public fr.expression4j.config.Constant[] getConstantArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                fr.expression4j.config.Constant[] result = new fr.expression4j.config.Constant[targetList.size()];
                targetList.toArray(result);
                return result;
            }
        }
         ...
         */
        public fr.expression4j.config.Constant getConstantArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Constant target = null;
                target = (fr.expression4j.config.Constant)get_store().find_element_user(CONSTANT$2, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
         ...
         */
        public void setConstantArray(fr.expression4j.config.Constant[] constantArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setConstantArray(int i, fr.expression4j.config.Constant constant)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public fr.expression4j.config.Constant insertNewConstant(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Constant target = null;
                target = (fr.expression4j.config.Constant)get_store().insert_element_user(CONSTANT$2, i);
                return target;
            }
        }
         ...
         */
        public fr.expression4j.config.Constant addNewConstant()
        {
            synchronized (monitor())
            {
                check_orphaned();
                fr.expression4j.config.Constant target = null;
                target = (fr.expression4j.config.Constant)get_store().add_element_user(CONSTANT$2);
                return target;
            }
        }
