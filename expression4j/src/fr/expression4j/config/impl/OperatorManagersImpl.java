 ...
 */
public class OperatorManagersImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements fr.expression4j.config.OperatorManagers
{
     ...
     */
    public fr.expression4j.config.OperatorManagerDocument.OperatorManager[] getOperatorManagerArray()
    {
        synchronized (monitor())
        {
            ...
            fr.expression4j.config.OperatorManagerDocument.OperatorManager[] result = new fr.expression4j.config.OperatorManagerDocument.OperatorManager[targetList.size()];
     ...
     */
    public fr.expression4j.config.OperatorManagerDocument.OperatorManager getOperatorManagerArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            fr.expression4j.config.OperatorManagerDocument.OperatorManager target = null;
            target = (fr.expression4j.config.OperatorManagerDocument.OperatorManager)get_store().find_element_user(OPERATORMANAGER$0, i);
            if (target == null)
            {
     ...
     */
    public void setOperatorManagerArray(fr.expression4j.config.OperatorManagerDocument.OperatorManager[] operatorManagerArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setOperatorManagerArray(int i, fr.expression4j.config.OperatorManagerDocument.OperatorManager operatorManager)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public fr.expression4j.config.OperatorManagerDocument.OperatorManager insertNewOperatorManager(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            fr.expression4j.config.OperatorManagerDocument.OperatorManager target = null;
            target = (fr.expression4j.config.OperatorManagerDocument.OperatorManager)get_store().insert_element_user(OPERATORMANAGER$0, i);
            return target;
        }
    }
