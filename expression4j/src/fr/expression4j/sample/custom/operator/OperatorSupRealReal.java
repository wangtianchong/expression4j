...
public class OperatorSupRealReal implements OperatorImpl {
	...
	public MathematicalElement compute(MathContext mc,MathematicalElement leftElement, MathematicalElement rightElement) throws EvalException {
		...
		BooleanMathematicalElement result = new BooleanMathematicalElement(leftElement.getRealValue(mc).compareTo(rightElement.getRealValue(mc))>0);
		return result;
	}
