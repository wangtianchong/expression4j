...
public class OperatorUnaryPlusComplex implements OperatorImpl {
	...
	public MathematicalElement compute(MathContext mc,MathematicalElement leftElement,
		...
		try {
			...
			BigDecimal realValue = leftElement.getRealValue(mc);
			BigDecimal complexValue = leftElement.getComplexValue(mc);
			return new ComplexImpl(realValue,complexValue);
		}
		catch (MathematicalException me) {
			throw new EvalException("Cannot evaluate value for unary plus complex .",me);
		}
	}
