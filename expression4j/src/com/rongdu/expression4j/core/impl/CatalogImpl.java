...
package com.rongdu.expression4j.core.impl;
...
import com.rongdu.expression4j.core.predefine.AbsFunction;
import com.rongdu.expression4j.core.predefine.AcosFunction;
import com.rongdu.expression4j.core.predefine.AsinFunction;
import com.rongdu.expression4j.core.predefine.AtanFunction;
import com.rongdu.expression4j.core.predefine.CeilFunction;
import com.rongdu.expression4j.core.predefine.CosFunction;
import com.rongdu.expression4j.core.predefine.CoshFunction;
import com.rongdu.expression4j.core.predefine.ExpFunction;
import com.rongdu.expression4j.core.predefine.FloorFunction;
import com.rongdu.expression4j.core.predefine.LogFunction;
import com.rongdu.expression4j.core.predefine.RandomFunction;
import com.rongdu.expression4j.core.predefine.SinFunction;
import com.rongdu.expression4j.core.predefine.SinhFunction;
import com.rongdu.expression4j.core.predefine.SqrtFunction;
import com.rongdu.expression4j.core.predefine.TanFunction;
...
public class CatalogImpl implements Catalog {
	...
	public CatalogImpl(String catalogName,MathContext mc) {
		...
		this.mc=mc;
		if(this.mc==null){
		    this.mc=MathUtil.getDefaultMathContext();
		}
		...
		MathematicalElement me = NumberFactory.createReal(new BigDecimal(3.1415926535897932384626433832795));
		constant.put("pi",me);
		me = NumberFactory.createReal(new BigDecimal(2.71828182845904523536028747135266249));
		constant.put("e",me);
}
	...
	public void addExpression(Expression expression) {
		if (expression != null) {
			...
			expression.setMathContext(getMathContext());
