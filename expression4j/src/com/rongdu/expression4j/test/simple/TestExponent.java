...
public class TestExponent extends TestCase {
	...
	public void testExponent1() {
		...
		try {
			...
			assertEquals(8.0,expression.evaluate(null).getRealValue(mc).doubleValue(),0);
		}
	...
	public void testExponent2() {
		...
		try {
			Expression expression = ExpressionFactory.createExpression(expressionString);
			assertEquals(16,expression.evaluate(null).getRealValue(mc).doubleValue(),0);
		}
		catch (ParsingException pe) {
			fail("Cannot parse simple expression. " + pe);
		}
	...
	public void testExponent3() {
		...
		try {
			Expression expression = ExpressionFactory.createExpression(expressionString);
			assertEquals(256,expression.evaluate(null).getRealValue(mc).doubleValue(),0);
		}
		catch (ParsingException pe) {
			fail("Cannot parse simple expression. " + pe);
		}
	...
	public void testExponentUnariOperator1() {
		...
		try {
			Expression expression = ExpressionFactory.createExpression(expressionString);
			assertEquals(4,expression.evaluate(null).getRealValue(mc).doubleValue(),0);
		}
		catch (ParsingException pe) {
			fail("Cannot parse simple expression. " + pe);
		}
	...
	public void testExponentUnariOperator2() {
		...
		try {
			Expression expression = ExpressionFactory.createExpression(expressionString);
			assertEquals(0.25,expression.evaluate(null).getRealValue(mc).doubleValue(),0);
		}
		catch (ParsingException pe) {
			fail("Cannot parse simple expression. " + pe);
		}
