...
import com.rongdu.expression4j.core.impl.CatalogImpl;
import com.rongdu.expression4j.core.impl.ExpressionImpl;
import com.rongdu.expression4j.core.impl.OptimizedExpression;
import com.rongdu.expression4j.core.impl.ParametersImpl;
...
public final class ExpressionFactory {
	...
	static {
		...
		generalCatalog = new CatalogImpl("general",MathUtil.getDefaultMathContext());
	...
	public static Expression createExpression(String expression,Catalog catalog, ExpressionModel model) throws ParsingException {
		...
		result.setMathContext(catalog.getMathContext());
	 ...
	 */
	public static Catalog createCatalog(String catalogName,MathContext mc) {
		log.debug("Create catalog: " + catalogName);
		
		Catalog tmpCatalog = (Catalog) catalogMap.get(catalogName);
		if (tmpCatalog == null) {
			tmpCatalog = new CatalogImpl(catalogName,mc);
