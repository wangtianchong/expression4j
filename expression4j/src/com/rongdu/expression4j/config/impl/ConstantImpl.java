 ...
 */
public class ConstantImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.Constant
{
     ...
     */
    public com.rongdu.expression4j.config.Constant.ConstantProperty[] getConstantPropertyArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            com.rongdu.expression4j.config.Constant.ConstantProperty[] result = new com.rongdu.expression4j.config.Constant.ConstantProperty[targetList.size()];
     ...
     */
    public com.rongdu.expression4j.config.Constant.ConstantProperty getConstantPropertyArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Constant.ConstantProperty target = null;
            target = (com.rongdu.expression4j.config.Constant.ConstantProperty)get_store().find_element_user(CONSTANTPROPERTY$2, i);
            if (target == null)
            {
     ...
     */
    public void setConstantPropertyArray(com.rongdu.expression4j.config.Constant.ConstantProperty[] constantPropertyArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setConstantPropertyArray(int i, com.rongdu.expression4j.config.Constant.ConstantProperty constantProperty)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.rongdu.expression4j.config.Constant.ConstantProperty insertNewConstantProperty(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Constant.ConstantProperty target = null;
            target = (com.rongdu.expression4j.config.Constant.ConstantProperty)get_store().insert_element_user(CONSTANTPROPERTY$2, i);
            return target;
        }
    }
     ...
     */
    public com.rongdu.expression4j.config.Constant.ConstantProperty addNewConstantProperty()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Constant.ConstantProperty target = null;
            target = (com.rongdu.expression4j.config.Constant.ConstantProperty)get_store().add_element_user(CONSTANTPROPERTY$2);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class ConstantPropertyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.Constant.ConstantProperty
    {
