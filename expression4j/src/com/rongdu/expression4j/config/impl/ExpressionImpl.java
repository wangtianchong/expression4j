 ...
 */
public class ExpressionImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.Expression
{
     ...
     */
    public com.rongdu.expression4j.config.Expression.Property[] getPropertyArray()
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            com.rongdu.expression4j.config.Expression.Property[] result = new com.rongdu.expression4j.config.Expression.Property[targetList.size()];
     ...
     */
    public com.rongdu.expression4j.config.Expression.Property getPropertyArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Expression.Property target = null;
            target = (com.rongdu.expression4j.config.Expression.Property)get_store().find_element_user(PROPERTY$8, i);
            if (target == null)
            {
     ...
     */
    public void setPropertyArray(com.rongdu.expression4j.config.Expression.Property[] propertyArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setPropertyArray(int i, com.rongdu.expression4j.config.Expression.Property property)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.rongdu.expression4j.config.Expression.Property insertNewProperty(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Expression.Property target = null;
            target = (com.rongdu.expression4j.config.Expression.Property)get_store().insert_element_user(PROPERTY$8, i);
            return target;
        }
    }
     ...
     */
    public com.rongdu.expression4j.config.Expression.Property addNewProperty()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.Expression.Property target = null;
            target = (com.rongdu.expression4j.config.Expression.Property)get_store().add_element_user(PROPERTY$8);
            return target;
        }
    }
     ...
     * This is a complex type.
     */
    public static class PropertyImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.Expression.Property
    {
