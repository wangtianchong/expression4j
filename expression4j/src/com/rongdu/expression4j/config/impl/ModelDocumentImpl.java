 ...
 */
public class ModelDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.ModelDocument
{
     ...
     */
    public com.rongdu.expression4j.config.ModelDocument.Model getModel()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.ModelDocument.Model target = null;
            target = (com.rongdu.expression4j.config.ModelDocument.Model)get_store().find_element_user(MODEL$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setModel(com.rongdu.expression4j.config.ModelDocument.Model model)
    {
        synchronized (monitor())
        {
            check_orphaned();
            ...
            if (target == null)
            {
                target = (com.rongdu.expression4j.config.ModelDocument.Model)get_store().add_element_user(MODEL$0);
            }
            target.set(model);
        }
    }
     ...
     */
    public com.rongdu.expression4j.config.ModelDocument.Model addNewModel()
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class ModelImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.ModelDocument.Model
    {
         ...
         */
        public com.rongdu.expression4j.config.BinaryOperator[] getBinaryOperatorArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                com.rongdu.expression4j.config.BinaryOperator[] result = new com.rongdu.expression4j.config.BinaryOperator[targetList.size()];
                targetList.toArray(result);
                return result;
            }
        }
         ...
         */
        public com.rongdu.expression4j.config.BinaryOperator getBinaryOperatorArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.BinaryOperator target = null;
                target = (com.rongdu.expression4j.config.BinaryOperator)get_store().find_element_user(BINARYOPERATOR$2, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
         ...
         */
        public void setBinaryOperatorArray(com.rongdu.expression4j.config.BinaryOperator[] binaryOperatorArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setBinaryOperatorArray(int i, com.rongdu.expression4j.config.BinaryOperator binaryOperator)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public com.rongdu.expression4j.config.BinaryOperator insertNewBinaryOperator(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.BinaryOperator target = null;
                target = (com.rongdu.expression4j.config.BinaryOperator)get_store().insert_element_user(BINARYOPERATOR$2, i);
                return target;
            }
        }
         ...
         */
        public com.rongdu.expression4j.config.BinaryOperator addNewBinaryOperator()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.BinaryOperator target = null;
                target = (com.rongdu.expression4j.config.BinaryOperator)get_store().add_element_user(BINARYOPERATOR$2);
                return target;
            }
        }
         ...
         */
        public com.rongdu.expression4j.config.ExpressionElement[] getExpressionElementArray()
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                com.rongdu.expression4j.config.ExpressionElement[] result = new com.rongdu.expression4j.config.ExpressionElement[targetList.size()];
                targetList.toArray(result);
                return result;
            }
        }
         ...
         */
        public com.rongdu.expression4j.config.ExpressionElement getExpressionElementArray(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.ExpressionElement target = null;
                target = (com.rongdu.expression4j.config.ExpressionElement)get_store().find_element_user(EXPRESSIONELEMENT$4, i);
                if (target == null)
                {
                    throw new IndexOutOfBoundsException();
                }
         ...
         */
        public void setExpressionElementArray(com.rongdu.expression4j.config.ExpressionElement[] expressionElementArray)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public void setExpressionElementArray(int i, com.rongdu.expression4j.config.ExpressionElement expressionElement)
        {
            synchronized (monitor())
            {
                check_orphaned();
         ...
         */
        public com.rongdu.expression4j.config.ExpressionElement insertNewExpressionElement(int i)
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.ExpressionElement target = null;
                target = (com.rongdu.expression4j.config.ExpressionElement)get_store().insert_element_user(EXPRESSIONELEMENT$4, i);
                return target;
            }
        }
         ...
         */
        public com.rongdu.expression4j.config.ExpressionElement addNewExpressionElement()
        {
            synchronized (monitor())
            {
                check_orphaned();
                com.rongdu.expression4j.config.ExpressionElement target = null;
                target = (com.rongdu.expression4j.config.ExpressionElement)get_store().add_element_user(EXPRESSIONELEMENT$4);
                return target;
            }
        }
