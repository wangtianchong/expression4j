 ...
 */
public class OperatorManagerDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.OperatorManagerDocument
{
     ...
     */
    public com.rongdu.expression4j.config.OperatorManagerDocument.OperatorManager getOperatorManager()
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.OperatorManagerDocument.OperatorManager target = null;
            target = (com.rongdu.expression4j.config.OperatorManagerDocument.OperatorManager)get_store().find_element_user(OPERATORMANAGER$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setOperatorManager(com.rongdu.expression4j.config.OperatorManagerDocument.OperatorManager operatorManager)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     * This is a complex type.
     */
    public static class OperatorManagerImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.OperatorManagerDocument.OperatorManager
    {
