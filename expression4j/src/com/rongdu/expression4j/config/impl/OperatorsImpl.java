 ...
 */
public class OperatorsImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.rongdu.expression4j.config.Operators
{
     ...
     */
    public com.rongdu.expression4j.config.OperatorDocument.Operator[] getOperatorArray()
    {
        synchronized (monitor())
        {
            ...
            com.rongdu.expression4j.config.OperatorDocument.Operator[] result = new com.rongdu.expression4j.config.OperatorDocument.Operator[targetList.size()];
     ...
     */
    public com.rongdu.expression4j.config.OperatorDocument.Operator getOperatorArray(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.OperatorDocument.Operator target = null;
            target = (com.rongdu.expression4j.config.OperatorDocument.Operator)get_store().find_element_user(OPERATOR$0, i);
            if (target == null)
            {
     ...
     */
    public void setOperatorArray(com.rongdu.expression4j.config.OperatorDocument.Operator[] operatorArray)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public void setOperatorArray(int i, com.rongdu.expression4j.config.OperatorDocument.Operator operator)
    {
        synchronized (monitor())
        {
            check_orphaned();
     ...
     */
    public com.rongdu.expression4j.config.OperatorDocument.Operator insertNewOperator(int i)
    {
        synchronized (monitor())
        {
            check_orphaned();
            com.rongdu.expression4j.config.OperatorDocument.Operator target = null;
            target = (com.rongdu.expression4j.config.OperatorDocument.Operator)get_store().insert_element_user(OPERATOR$0, i);
            return target;
        }
    }
