...
package com.rongdu.expression4j.basic.operatorimpl.real;
...
public class OperatorPowRealReal implements OperatorImpl {
	...
	public MathematicalElement compute(MathContext mc,MathematicalElement leftElement,
		...
		double result=Math.pow(leftElement.getRealValue(mc).doubleValue(),rightElement.getRealValue(mc).doubleValue());
		
		return new RealImpl(new BigDecimal(result,mc));
	}
