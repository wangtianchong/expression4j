...
public class OperatorUnaryMinusReal implements OperatorImpl {
	...
	public MathematicalElement compute(MathContext mc,MathematicalElement leftElement,
		...
		if (leftElement.getType() != 1) {
			throw new EvalException("Incosistent element type for operator unary plus real.");
		}
		
		return new RealImpl(leftElement.getRealValue(mc).negate());
	}
