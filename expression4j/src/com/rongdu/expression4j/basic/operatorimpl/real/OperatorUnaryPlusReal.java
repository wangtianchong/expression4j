...
public class OperatorUnaryPlusReal implements OperatorImpl {
	...
	public String getOperatorName() {
		return Operator.OPERATOR_UNARY_PLUS;
	}
	...
	public MathematicalElement compute(MathContext mc,MathematicalElement leftElement,
		...
		if (leftElement.getType() != 1) {
			throw new EvalException("Incosistent element type for operator unary minus real.");
		}
		
		return new RealImpl(leftElement.getRealValue(mc));
	}
