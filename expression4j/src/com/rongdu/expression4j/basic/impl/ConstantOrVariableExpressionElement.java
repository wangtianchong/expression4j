 ...
 *
 */
public class ConstantOrVariableExpressionElement implements ExpressionElement {

	public ConstantOrVariableExpressionElement() {
		super();
	}
	...
	public boolean parseElement(String expression, ExpressionModel expressionModel, ParseInfo parseInfo, Catalog catalog, List functionParameters, int priorityOperatorLevel) throws ParsingException {
		...
		//check if variable is present in function parameter
		if (!functionParameters.contains(constantOrVariableName)) {
			//varible not found in function parameters
			throw new ParsingException("Variable " + constantOrVariableName + " not found in parameters definition.");
		}
	...
	public String getName() {
		return "ConstantOrVariableExpressionElement";
	}
