...
public class OperatorManagerImpl implements OperatorManager {
	...
	public MathematicalElement computeValue(MathContext mc,String operatorName,
		...
		return currentOperatorImpl.compute(mc,element,null);
	}
	...
	public MathematicalElement computeValue(MathContext mc,String operatorName,
		...
		return currentOperatorImpl.compute(mc,leftElement,rightElement);
	}
