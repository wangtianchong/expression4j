...
package com.rongdu.expression4j.basic;
...
public interface OperatorManager {
	 ...
	 */
	public MathematicalElement computeValue(MathContext mc,String operatorName,MathematicalElement element) throws EvalException;
	 ...
	 */
	public MathematicalElement computeValue(MathContext mc,String operatorName,MathematicalElement leftElement,MathematicalElement rightElement) throws EvalException;
