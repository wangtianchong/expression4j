...
public class CustomExpressionElement2 {
	...
	public static void main(String[] args) {
		try {
			...
			Expression expression2 = ExpressionFactory.createExpression("g(x,y)=f(y)+' '+(x+' '+f(x+y))",
					ExpressionFactory.getCatalog(),stringExpressionModel);
			...
			MathematicalElement result = expression2.evaluate(stringOperatorManager,parameters);
