...
public class MyFirstExpressionWithParameters {
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("Value of expression for x=2 and y = 4:" + expression.evaluate(parameters).getRealValue(MathUtil.getDefaultMathContext()));
			...
			System.out.println("Value of expression for x=3 and y = 2:" + expression.evaluate(parameters).getRealValue(MathUtil.getDefaultMathContext()));
		}
		catch (Exception e) {
