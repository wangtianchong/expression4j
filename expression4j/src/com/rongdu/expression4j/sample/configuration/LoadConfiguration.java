...
public class LoadConfiguration {
	...
	public static void main(String[] args) {
		try {
			...
			parameters.addParameter("x", NumberFactory.createReal(new BigDecimal(30)));
			
			Catalog defaultCatalog = ExpressionFactory.getCatalog();
			
			Expression expression = defaultCatalog.getExpression("h");
